...
private:
    ...
    int repeticionValorMasFrecuente;
public:
    ...
    vector<float> &getPrimerosValores();

    vector<float> &getSegundosValores();

    vector<float> &getTercerosValores();

    vector<float> &getValoresPromedio();
