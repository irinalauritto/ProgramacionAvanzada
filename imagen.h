...
public:
     ...
     */
    void modificarPixel(int columna, int fila, int pPrimerComponente, int pSegundaComponente, int pTercerComponente);

    /**
     * @brief aumentarBrillo Método que permite aumentar el brillo de la imagen.
     */
    void aumentarBrillo();

    /**
     * @brief disminuirBrillo Método que permite disminuir el brillo de la imagen.
     */
    void disminuirBrillo();

    /**
     * @brief ajustarContraste Método que permite ajustar el contraste de la imagen.
     */
    void ajustarContraste();

//    void setCantidadColumnas(unsigned int newCantidadColumnas);
    //    void setCantidadFilas(unsigned int newCantidadFilas);
};
