...
private:
    ...
    /**
     * @brief componentes Vector que modela las componentes de un píxel.
     */
...
public:
    ...
    */
    ...
    /**
     * @brief operator = Sobrecarga del operador =
     * @param pPixel Objeto Pixel con el cual se efectuará la asignacion de pixeles.
     */
    void operator = (Pixel pPixel);
