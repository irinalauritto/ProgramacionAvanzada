...
/**
 * @brief The GestorEstadistico class
 */
...
public:
    ...
    //Mtodos relacionados al cÃ¡lculo de parÃ¡metros estadÃ­sticos de imÃ¡genes con pÃ­xeles RGB
    float promedioR(Imagen &i);
    float desvioEstandarR(Imagen &i);
