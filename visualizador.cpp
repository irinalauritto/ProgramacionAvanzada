...
void Visualizador::keyPressEvent(QKeyEvent *evento)
{
    ...
    if(controlPresionada and unoPresionado)
    {
        ...
        pseudocoloreador.colorearLUT1(&imagen);
    }
    ...
    if(controlPresionada and dosPresionado)
    {
        ...
        pseudocoloreador.colorearLUT2(&imagen);
    }
...
{
    clickIzquierdoPresionado = evento->button() == Qt::LeftButton;

    if(clickIzquierdoPresionado == true && controlPresionada == true)
    {
